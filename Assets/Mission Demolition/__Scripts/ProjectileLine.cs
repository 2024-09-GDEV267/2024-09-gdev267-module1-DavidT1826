...
public class ProjectileLine : MonoBehaviour
{
    ...
    public void AddPoint() 
    {
        ...
        {
            //If the point isn't far enough from teh last point, it returns
            return;
        }
    ...
    public Vector3 lastPoint
    {
        get
        {
            if (points == null)
            {
                //If there are no points, retuns Vector3.zero
                return(Vector3.zero);
            }
    ...
    {
        {
            ...
            if (FollowCam.POI == null)
            {
                //Once FollowCam.POI is null, make the localpoi null too
                poi = null;
            }
        }
    }
